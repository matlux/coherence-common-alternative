...
/**
 * <p>A base implementation for {@link PartitionTransferEvent}s.</p>
 * 
 * @author Brian Oliver
 */
...
{
    /**
     * <p>The {@link Member} from which the partition transfer occurred.</p>
     */
    private Member memberFrom;

    /**
     * <p>The {@link Member} to which the partition transfer occurred.</p>
     */
