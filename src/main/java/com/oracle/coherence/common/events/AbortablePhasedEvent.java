...
/**
 * <p>A {@link AbortablePhasedEvent} is a specialized {@link Event}, much like a
 ...
 * that of which may also aborted.</p>
 * 
 * @author Brian Oliver
 */
public interface AbortablePhasedEvent extends Event
{
    ...
    /**
     * <p>The valid {@link Phase}s for the {@link AbortablePhasedEvent}.</p>
     */
    public enum Phase
    {
        /**
    ...
    /**
     * <p>Returns the {@link Phase} of the {@link AbortablePhasedEvent}.</p>
     * 
