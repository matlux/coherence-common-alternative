...
public class ExtensibleEnvironment extends DefaultConfigurableCacheFactory implements Environment
{
    ...
    /**
     * <p>The set of resources that have been registered with the environment, organized by {@link Class} and name </p>
     */
    ...
    /**
     * <p>The set of {@link com.tangosol.net.NamedCache} names that have been realized by this {@link ExtensibleEnvironment}.</p>
     * 
     * <p>We use this to keep track of the {@link com.oracle.coherence.common.events.lifecycle.NamedCacheLifecycleEvent}s to raise.</p>
     */
                                               ...
                                               NoArgsBuilder<R> builder)
    {
        if (name == null)
        {
            throw new IllegalArgumentException(String.format(
                "Attempted to registerResource(%s, null) with a null name.  null names are not supported", clazz));
        }
        else
        {
            ...
            else
            {
                logger
                    .warning(String
                        .format(
                            "Environment resource [%s] of type [%s] is already registered as [%s].  Skipping requested registration.",
                            name, clazz, resource));
    ...
    public void setConfig(XmlElement xmlConfig)
    {
        ...
        catch (URISyntaxException uriSyntaxException)
        {
            ...
            throw new RuntimeException(
                "FATAL ERROR: The internal URI created by the ExtensibleEnvironment is invalid.", uriSyntaxException);
        }
